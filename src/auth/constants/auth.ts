...
export const LOGIN_STATUS = {
    COMPLETED: "로그인이 완료되었어요.",
    FAILED: "로그인에 실패했어요.",
}

export const LOGIN_OR_SIGNUP = "로그인 또는 회원가입"

export const INTRO = "매일 아침 8시, 아티클과 3개의 문제를 이메일로 보내드려요."

export const SIGNUP_PROGRESS = {
    EMAIL_SENT_EMAIL: "입력해주신 이메일로",
    EMAIL_SENT_LINK: "인증 링크를 보내드렸어요!",
    COMPLETE_MESSAGE: "메일함에서 링크를 누르면 가입이 완료됩니다.",
